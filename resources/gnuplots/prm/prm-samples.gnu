...
set xlabel "Liczba probek" font ",10"
set ylabel "Dlugosc trasy [m]"

set title "Dlugosc sciezki" font ",15"
plot [1:2000]'prm-samples.dat' using 1:2  w lp title "RRT" pt 7 ps 2

set title "Czas wyszukiwania" font ",15"
set ylabel "Czas wyszukiwania [ms]"
plot [1:2000]'prm-samples.dat' using 1:3 w lp title "RRT" pt 7 ps 2
