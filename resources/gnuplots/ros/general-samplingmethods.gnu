...
plot [1:4]'rrt.dat' using 1:2  w lp title "RRT" pt 7 ps 2, 'navfn.dat' using 1:2 w lp title "Navfn" pt 7 ps 2,

set title "Czas wyszukiwania" font ",15"
set ylabel "Czas wyszukiwania [ms]"
plot [1:4]'rrt.dat' using 1:3 w lp title "RRT" pt 7 ps 2, 'navfn.dat' using 1:3 w lp title "Navfn" pt 7 ps 2,
